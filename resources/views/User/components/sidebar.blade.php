...
<div class="p-3 pb-0">
  <a href="index.html" class="d-flex align-items- gap-2 justify-content-center">
    <div>
      <img src="/Admin/assets/icons/box.png" width="40" alt="">
    </div>
   
    <h5 class="text-primary">Northern Inventory Management</h5>
  </a>
...
<ul class="menu-inner py-1">
  ...
  <li class="menu-item">
    ...
    <ul class="menu-sub">
      ...
      <li class="menu-item">
        <a href="#" class="menu-link">
          <div data-i18n="Connections">Calceled Order</div>
        </a>
      </li>
    </ul>
  </li>
  ...
  <li class="menu-item">
    <a href="javascript:void(0);" class="menu-link menu-toggle">
      ...
      <div data-i18n="Misc">User List</div>
    </a>
    <ul class="menu-sub">
      <li class="menu-item">
