                    ...
                    <div class="card-body">
                        ...
                        <div class="p-3 py-3 mb-2" style="background-color:#EEEEEE; border-radius:8px;">
                            <a href="/" class="">
                                ...
                                <img src="/Admin/assets/logos/logo.png" width="80" alt="">
                            </a>
                        </div>
                        <!-- /Logo -->
                        <h5 class="mb-2">User Login! 👋</h5>
                        <form id="formAuthentication" class="mb-3" action="{{ route('user.profile') }}" method="POST">
